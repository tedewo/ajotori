          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <Link href="/ilmoitus/uusi" className="inline-flex items-center justify-center rounded-[28px] bg-[#0ea5e9] px-6 py-3 text-base font-semibold text-white shadow-md transition hover:bg-[#0ca4dd]">
                  Luo ilmoitus
                </Link>
              </div>
            </div>
